...
HD_PWD='C:/Users/test/Desktop/vivado_projects/lab_1_practice/lab_1_practice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log labpractice1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source labpractice1.tcl
