...
HD_PWD='C:/Users/test/Desktop/vivado_projects/lab2_prob2/lab2_prob2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prob2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prob2.tcl
