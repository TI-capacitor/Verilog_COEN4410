...
HD_PWD='C:/Users/test/Desktop/vivado_projects/lab_2_prob1/lab_2_prob1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prob1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prob1.tcl
