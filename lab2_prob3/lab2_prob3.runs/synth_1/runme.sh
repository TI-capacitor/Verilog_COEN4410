...
HD_PWD='C:/Users/test/Desktop/vivado_projects/lab2_prob3/lab2_prob3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prob3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prob3.tcl
